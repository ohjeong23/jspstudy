...
<%--
  ...
  3. <%@ taglib %>  : JSTL(JavaServerPage Standard Tag Library) 자바용 태그, 자바 문법을 태그로 만듬 if for 같은 태그들
 --%>
...
<%--
  표현식 (Expression)
  1. Java 값을 나타날 때 사용한다. (변수, 메소드 반환 등)
  2.<%= Java 값 %>
 --%>
<div><%=a%></div>
...
<%--
 ...
 %>
  ...
  <%--
    ...
    2. 반대는 안 된다. 자바 스크립트 변수는 자바로 가져올 수 없다.
   --%>
  <script>
    alert(<%=a%>); 
  </script>
